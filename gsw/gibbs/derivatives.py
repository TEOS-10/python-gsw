...
def pt_first_derivatives(SA, CT):
    ...
    computationally efficient 48-term expression for the density of gsw.in
    terms of Conservative Temperature, and related properties of gsw. To
    be submitted to Ocean Science Discussions.

    Modifications:
    2010-08-24. Trevor McDougall.
    """
...
def CT_second_derivatives(SA, pt):
    ...
    def CT_derivative_SA_SA(SA, pt):
        ...
        CT_SA_l, dummy = CT_first_derivatives(SA_l, pt)
        CT_SA_u, dummy = CT_first_derivatives(SA_u, pt)
...
def enthalpy_second_derivatives(SA, CT, p):
    ...
    # NOTE: The matlab version 3.0 mentions that this fuciont is unchanged, but
    # that's not true!
